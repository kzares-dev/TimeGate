...
function LeaderBoardPreview() {
  ...
  useEffect(() => {
    ...
    getLeaderBoard(1, 5).then((data: any) => setLeaderBoard(data))
  }, [])
  ...
  return <Link href="/leaderboard" className="flex-1 relative flex lg:col-span-2 bg-white h-auto big-border py-5 px-2 pl-5 flex-col cursor-pointer" >
