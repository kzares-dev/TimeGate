...
function CheckedQuiz({ state }: { state: any }) {
    ...
    return (
        <div className="lg:container pt-[150px] flex flex-col gap-5">
            ...
            {state.solutionsArray.quizSolutions.map((sol: number, i: number) => {
                ...
                return <div className="flex flex-row">
                    ...
                    <div className="mx-4 border px-3 py-1 rounded-md bg-black text-white font-kalam font-bold flex gap-4 flex-center w-7 h-7 md:w-10 md:h-10 my-auto">
                        {i + 1}
                    </div>

                    <div className="text-left w-2/3">
                        <h1 className="font-mono text-neutral-700 text-[12px] md:text-xl"> {question} </h1>
                        <h2 className="font-mono text-lg md:text-2xl font-bold"> {correctSolution} </h2>
                    </div>
            ...
            <div className="grid gap-4 mt-4 md:grid-cols-2 pb-10 lg:pb-1">
                ...
                <Link href="/home">
                    <div className='flex-1 flex flex-col bg-gray-50/10 shadow-sm md-border cursor-pointer px-5 py-5 gap-2 relative' >
                        ...
                        <h1 className='text-2xl md:text-4xl font-kalam font-semibold'>Volver a Inicio</h1>
                        <p className='tet-[17px] md:text-lg font-mono leading-tight'>Haz realizado un buen trabajo, sigue resolviendo problemas para ganar puntos y aspirar a ser el mejor</p>
